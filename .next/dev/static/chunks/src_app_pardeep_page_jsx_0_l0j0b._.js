...
"[project]/src/app/pardeep/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ARHUD = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].lazy(()=>__turbopack_context__.A("[project]/src/components/ARGestureControl.jsx [app-client] (ecmascript, async loader)"));
_c = ARHUD;
function PardeepInterstellar() {
    ...
    const miniVidTopRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    // ✅ Global AR data from backend WS
    const { pinch, swipe, confidence } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ar$2f$useAR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    const [arEnabled, setArEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const slides = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PardeepInterstellar.useMemo[slides]": ()=>[
                {
                    key: "summary",
                    title: "SUMMARY",
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PardeepInterstellar.useEffect": ()=>{
            ...
            return ({
                "PardeepInterstellar.useEffect": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].killTweensOf(card)
            })["PardeepInterstellar.useEffect"];
        }
    }["PardeepInterstellar.useEffect"], [
        idx
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PardeepInterstellar.useEffect": ()=>{
            const onWheel = {
                "PardeepInterstellar.useEffect.onWheel": (e)=>{
                    if (Math.abs(e.deltaY) < 20) return;
                    if (e.deltaY > 0) goBy(1);
                    else goBy(-1);
                }
            }["PardeepInterstellar.useEffect.onWheel"];
            window.addEventListener("wheel", onWheel, {
                passive: true
            });
            return ({
                "PardeepInterstellar.useEffect": ()=>window.removeEventListener("wheel", onWheel)
            })["PardeepInterstellar.useEffect"];
        }
    }["PardeepInterstellar.useEffect"], []);
    // ---- Keyboard slide
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PardeepInterstellar.useEffect": ()=>{
            const onKey = {
                "PardeepInterstellar.useEffect.onKey": (e)=>{
                    if (e.key === "ArrowRight") goBy(1);
                    if (e.key === "ArrowLeft") goBy(-1);
                }
            }["PardeepInterstellar.useEffect.onKey"];
            window.addEventListener("keydown", onKey);
            return ({
                "PardeepInterstellar.useEffect": ()=>window.removeEventListener("keydown", onKey)
            })["PardeepInterstellar.useEffect"];
        }
    }["PardeepInterstellar.useEffect"], []);
    // ---- Swipe slide (mouse + touch)
    const swipeLocal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        x: 0,
        y: 0,
        down: false
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PardeepInterstellar.useEffect": ()=>{
            ...
            if (!rail) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(rail, {
                transformPerspective: 900,
                transformOrigin: "50% 50%"
            });
            const onMove = {
                "PardeepInterstellar.useEffect.onMove": (ev)=>{
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(rail, {
                        rotateY: cx * 7,
                        rotateX: -cy * 6,
                        x: cx * 10,
                        y: cy * 8,
            ...
            }["PardeepInterstellar.useEffect.onMove"];
            const reset = {
                "PardeepInterstellar.useEffect.reset": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(rail, {
                        rotateX: 0,
                        rotateY: 0,
                        x: 0,
            ...
            const drift = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(rail, {
                y: "-=6",
                duration: 2.8,
                ease: "sine.inOut",
                yoyo: true,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PardeepInterstellar.useEffect": ()=>{
            ...
            let cancelled = false;
            const tryPlay = {
                "PardeepInterstellar.useEffect.tryPlay": async ()=>{
                    try {
                        v.muted = true;
                        v.playsInline = true;
                        v.currentTime = 0;
            ...
            }["PardeepInterstellar.useEffect.tryPlay"];
            const onEnded = {
                "PardeepInterstellar.useEffect.onEnded": ()=>{
                    if (cancelled) return;
                    v.pause();
                }
            }["PardeepInterstellar.useEffect.onEnded"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            arEnabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
                fallback: null,
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ARHUD, {
                    active: true
                }, void 0, false, {
                    fileName: "[project]/src/app/pardeep/page.jsx",
                    lineNumber: 317,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "thumbs",
                                children: slides.map((x, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "card-body",
                                    children: s.body.map((t, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "bullet",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "b-dot"
...
_s(PardeepInterstellar, "3cp1dErKNsPtmQAPs9v4TLsa2d8=", false, function() {
    return [
...
`;
var _c, _c1;
__turbopack_context__.k.register(_c, "ARHUD");
__turbopack_context__.k.register(_c1, "PardeepInterstellar");
...
//# sourceMappingURL=src_app_pardeep_page_jsx_0_l0j0b._.js.map